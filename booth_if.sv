...
( input bit	clk, rst );
	...
	(
		...
		input clk, rst, out_data_1, out_data_2, data_req, done, sign_out, zero_out
	);
	...
	(
		...
		output out_data_1, out_data_2, data_req, done, sign_out, zero_out
